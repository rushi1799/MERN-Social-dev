...
// remove comment
export const removeComment = (postId, coommentId) => async (dispatch) => {
  try {
    await axios.delete(`/api/posts/comment/${postId}/${coommentId}`);

    dispatch({ type: REMOVE_COMMENT, payload: coommentId });
